...
summary: 'Vous pouvez utiliser les fichiers d"exemple pour regrouper quatre interfaces physiques Linux dans une seule liaison LACP, puis établir trois interfaces VLAN sous-tendant la liaison à utiliser comme interfaces StorageGRID Grid, Admin et Client Network.' 
---
...
[role="lead"]
Vous pouvez utiliser les fichiers d'exemple pour regrouper quatre interfaces physiques Linux dans une seule liaison LACP, puis établir trois interfaces VLAN sous-tendant la liaison à utiliser comme interfaces StorageGRID Grid, Admin et Client Network.
