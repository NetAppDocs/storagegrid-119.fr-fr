...
summary: 'L"alerte de faible capacité de stockage des données d"objets surveille l"espace disponible pour le stockage des données d"objets sur chaque nœud de stockage.' 
---
