...
Créé lors d'opérations d'agrandissement.  Contient un enregistrement des événements d'extension.
 a| 
Nœuds de stockage
...
Créé lors de l'exécution du `pa-move.sh` scénario.
 a| 
...
Créé par le service GDU.  Contient les événements liés aux procédures de provisionnement et de maintenance gérées par le nœud d'administration principal.
 a| 
Nœud d'administration principal
...
Créé lors de la mise à niveau du logiciel.  Contient un enregistrement des événements de mise à jour du logiciel.
 a| 
Tous les nœuds
